import { VM, Program, ExecuteStatus } from "intcode-wasm";
...
const renderScreen = (screen) => {
    ...
    const width = (max_x - min_x + 1) * 10;
    const height = (max_y - min_y + 1) * 10;
    ...
    screen.forEach(tile => {
        ...
        ctx.fillRect((tile.x - min_x) * 10, (tile.y - min_y) * 10, 9, 9);
    });

    ctx.fillStyle = 'rgb(0, 240, 0)';
    ctx.fillRect((x - min_x) * 10, (y - min_y) * 10, 9, 9);
};
